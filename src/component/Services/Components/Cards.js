...
const Cards = () => {
  ...
  const cardsData = [
    ...
    { id: 5, title: "Cloud Computing", content: "Our comprehensive suite of cloud services is designed to propel businesses into the future...", path: "/cloud-computing" },
    { id: 6, title: "UI/UX & Graphics", content: "Our designers’ creativity craves the user’s interest by creating interactive and visually engaging...", path: "/ui-ux-graphics" },
  ];
